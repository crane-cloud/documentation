...
*IF* the email provided does not match any user account, the following error shall display, “Invalid user, please create an account “. You are required to navigate to http://cranecloud.io/register and create an account with Crane Cloud in such a scenario.
